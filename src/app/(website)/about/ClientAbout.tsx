  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-4xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
              About Akuafi – <span className="text-primary">Where Offline Meets Online Marketing</span>
            </h1>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              We help brands transform everyday water bottles into powerful advertising tools that generate real engagement, real data, and real sales.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
               <span className="inline-block px-4 py-1 rounded-full bg-blue-50 text-primary font-bold text-sm uppercase tracking-wide mb-4">Our Story</span>
               <h2 className="text-3xl lg:text-4xl font-bold text-slate-900">Revolutionizing the Simplest Medium</h2>
            </div>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
               ...
               <div>
                  ...
                  <h3 className="text-xl text-slate-300 mb-6">Traditional Offline Advertising is Blind & Costly</h3>
               ...
               <div className="bg-white/5 p-8 rounded-3xl border border-white/10 backdrop-blur-sm">
                  ...
                  <h3 className="text-xl text-slate-300 mb-6 font-semibold">Smart Bottle Advertising Ecosystem</h3>
                  <div className="space-y-6">
                     <div className="flex gap-4">
                        <div className="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center text-primary-light flex-shrink-0">1</div>
                        <div>
                           <h4 className="font-bold text-white mb-1">Bottled Branding™</h4>
                           <p className="text-sm text-slate-400">Premium physical visibility.</p>
                        </div>
                     </div>
                     <div className="flex gap-4">
                        <div className="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center text-primary-light flex-shrink-0">2</div>
                        <div>
                           <h4 className="font-bold text-white mb-1">QR Engage™ Technology</h4>
                           <p className="text-sm text-slate-400">Interactive digital bridge.</p>
                        </div>
                     </div>
                     <div className="flex gap-4">
                        <div className="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center text-primary-light flex-shrink-0">3</div>
                        <div>
                           <h4 className="font-bold text-white mb-1">Analytics Dashboard</h4>
      ...
      <section className="py-24 bg-surface">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
               <div className="bg-white p-8 rounded-2xl shadow-soft-sm border border-slate-100">
                  ...
                  <p className="text-slate-600 leading-relaxed text-lg">
                     To empower brands with traceable, high-impact offline advertising solutions that connect physical impressions to digital actions.
                  </p>
               </div>
               <div className="bg-white p-8 rounded-2xl shadow-soft-sm border border-slate-100">
                  <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-2">
                  ...
                  <p className="text-slate-600 leading-relaxed text-lg">
                     To become India’s leading smart offline media network, turning everyday objects into intelligent communication channels.
                  </p>
               </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
               {[
                  { icon: Sparkles, label: "Innovation", desc: "Always rethinking traditional media." },
                  { icon: Search, label: "Transparency", desc: "Data you can trust, fully open." },
                  { icon: Leaf, label: "Sustainability", desc: "Advertising that gives back." },
                  { icon: Users, label: "Customer Success", desc: "Your growth is our goal." },
                  { icon: Gift, label: "Affordability", desc: "Accessible for all businesses." }
               ].map((val, i) => (
                  <div key={i} className="bg-white p-6 rounded-xl border border-slate-100 text-center hover:shadow-soft-md transition-all">
      ...
      <section className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">From local startups to national giants, we have a solution for everyone.</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
             {[
               ...
               { icon: Vote, label: "Political & Social Campaigns" },
                ...
                <div key={idx} className="flex flex-col items-center justify-center p-8 bg-white rounded-2xl shadow-sm border border-slate-100 hover:border-primary/30 transition-all text-center h-full">
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
               <span className="text-primary font-bold uppercase tracking-wider text-sm">Future Direction</span>
               <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mt-2 mb-6">Our Roadmap</h2>
               <p className="text-slate-600 max-w-2xl mx-auto">We are constantly innovating to bring you better tools.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
               {[
                  { icon: Rocket, title: "AI Campaign Optimization", desc: "Automated insights to improve scan rates." },
                  { icon: MessageSquare, title: "WhatsApp Automation", desc: "Direct-to-chat redirections & bots." },
                  { icon: Users, title: "CRM Integrations", desc: "Sync leads directly to your sales pipeline." },
                  { icon: Gift, title: "Loyalty Systems", desc: "Scan-to-earn rewards & couponing." },
                  { icon: Languages, title: "Regional Support", desc: "Multilingual ad campaigns for deeper reach." },
                  { icon: UserPlus, title: "Reseller Programs", desc: "Franchising opportunities across states." },
               ].map((item, i) => (
                  <div key={i} className="flex gap-4 p-6 bg-white rounded-xl border border-slate-200/60 items-start">
      ...
      <section className="py-24 bg-slate-900 text-white relative text-center">
         <div className="max-w-4xl mx-auto px-4 relative z-10">
           <h2 className="text-4xl lg:text-5xl font-bold mb-6">Ready to Transform Your Offline Ads?</h2>
