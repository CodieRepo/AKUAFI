  ...
  const pricingFactors = [
    {
      ...
      description:
        "Pricing varies based on volume and number of distribution points.",
    },
    {
      icon: <Palette size={24} />,
      title: "Bottle Customization",
      description:
        "Choose between rPET or Aluminum, plus label size and finishes.",
    },
    {
      icon: <Smartphone size={24} />,
      title: "QR Technology",
      description:
        "Basic redirection, lead forms, or full interactive video experiences.",
    },
    {
      icon: <Calendar size={24} />,
      title: "Campaign Duration",
      description:
        "Short-term event promotions vs. Always-on seasonal campaigns.",
    },
  ];
  ...
  const tiers = [
    {
      ...
      description:
        "Ideal for local businesses, events, and short-term promotions.",
      features: [
    ...
    },
    {
      ...
      description:
        "Designed for scaling brands requiring multi-location reach.",
      features: [
    ...
    },
    {
      ...
      description:
        "For national brands needing high volume and deep integration.",
      features: [
  ...
  const faqs = [
    {
      ...
      answer:
        "Every brand&apos;s goals are different. A local cafe needs a different strategy than a national tech company. By customizing every campaign, we ensure you pay only for what you need—whether that&apos;s specific zip codes, premium bottle materials, or advanced digital features—without carrying the cost of unnecessary add-ons.",
    },
    {
      question: "Is there a minimum order quantity?",
      answer:
        "We strive to be accessible. While we have operational minimums to ensure campaign effectiveness and distribution impact, we work with brands of various sizes. Contact us to discuss what makes sense for your budget.",
    },
    {
      question: "What is included in the 'Green Impact'?",
      answer:
        "Responsible advertising is our core promise. Every campaign includes a contribution to our sustainability initiatives, such as plastic recycling drives and tree plantation projects. We handle the logistics of this so you can focus on your brand.",
    },
    {
      question: "Can I choose exactly where my bottles are distributed?",
      answer:
        "Yes. Our 'Growth' and 'Enterprise' plans offer granular distribution targeting. We can focus on fitness centers, corporate offices, cafes, or specific events to ensure your brand reaches the right audience.",
    },
  ];
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        >
          ...
          >
            ...
            We design custom pricing based on your campaign size, location, and
            marketing goals.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600">
              Select the tier that matches your ambitions. We handle the rest.
            </p>
          </div>
                  ...
                  <ul className="space-y-4">
                    {tier.features.map((feature, i) => (
                      <li key={i} className="flex items-start gap-3 text-sm">
                        <div
                          className={`mt-0.5 rounded-full p-0.5 shrink-0 ${tier.highlight ? "bg-primary/10 text-primary" : "bg-slate-100 text-slate-500"}`}
                        >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              Why Smart Offline Ads Win
            </h2>
            <p className="text-slate-600">
              See how AKUAFI compares to traditional offline channels.
            </p>
          </div>
              ...
              <table className="w-full min-w-[600px]">
                <thead>
                  <tr className="border-b border-slate-200 bg-slate-50">
                    <th className="py-6 px-8 text-left text-sm font-semibold text-slate-500 uppercase tracking-wider w-1/3">
                      Feature
                    </th>
                    <th className="py-6 px-8 text-center text-sm font-bold text-primary uppercase tracking-wider w-1/3 bg-primary/5">
                      AKUAFI
                    </th>
                    <th className="py-6 px-8 text-center text-sm font-semibold text-slate-400 uppercase tracking-wider w-1/3">
                      Traditional Ads
                      <br />
                ...
                <tbody className="divide-y divide-slate-200">
                  <tr>
                    <td className="py-6 px-8 text-slate-900 font-bold">
                      Real-Time Tracking
                    </td>
                    <td className="py-6 px-8 text-center bg-primary/5 text-primary">
                  ...
                  <tr>
                    ...
                    <td className="py-6 px-8 text-center bg-primary/5 text-slate-700 text-sm font-medium">
                      100% (Bottle in hand)
                    </td>
                    <td className="py-6 px-8 text-center text-slate-500 text-sm">
                      Passive / Ignored
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="py-6 px-8 text-center bg-primary/5 text-success font-bold text-sm">
                      Net Positive
                    </td>
                    <td className="py-6 px-8 text-center text-slate-500 text-sm">
                      High Waste
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Get Your Custom Pricing in 24 Hours
          </h2>
          <p className="text-slate-400 text-lg mb-10 max-w-2xl mx-auto">
            Ready to disrupt offline advertising? Let&apos;s build a campaign
            that fits your budget and amplifies your brand.
          </p>
