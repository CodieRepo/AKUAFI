    ...
    <div className="max-w-4xl mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-2">
          Define campaign duration and coupon rules.
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-[10px] text-gray-500 mt-1">
                  Shown in admin list for filtering.
                </p>
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-900 dark:text-gray-200 mb-2">
                  Campaign Month/Date (Optional)
                </label>
                <input
                  name="campaign_date"
                  type="date"
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="max-w-xs">
                ...
                <p className="text-[10px] text-gray-400 mt-1">
                  Used to calculate estimated revenue: claimed coupons × this
                  value.
                </p>
              </div>
            </div>
          ...
          <div className="p-8 flex items-center justify-end gap-4 bg-gray-50 dark:bg-slate-900 border-t border-gray-200 dark:border-slate-800 rounded-b-xl">
            <Link href="/admin/campaigns">
              <Button
                variant="ghost"
                type="button"
                className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white h-11"
              >
                Cancel
              </Button>
            </Link>
            <Button
              type="submit"
              disabled={loading}
              className="w-full sm:w-auto shadow-lg h-11 px-8 bg-blue-600 hover:bg-blue-700 text-white border-0"
            >
              {loading ? (
