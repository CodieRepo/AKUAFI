...
export default function CreateClientModal({ isOpen, onClose, onSuccess }: CreateClientModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!formData.client_name || !formData.email || !formData.password || !formData.confirmPassword) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
          <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100">Create New Client</h2>
          <button 
            onClick={onClose}
