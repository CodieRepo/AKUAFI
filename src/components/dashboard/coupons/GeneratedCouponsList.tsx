    ...
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 p-6 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Track issued QR coupons and their status.</p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
                <div className="px-3 py-1 rounded-full bg-gray-100 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-xs text-gray-600 dark:text-slate-300">
                    Total: <span className="text-gray-900 dark:text-white font-bold">{summary.total}</span>
                </div>
                <div className="px-3 py-1 rounded-full bg-emerald-50 dark:bg-slate-800 border border-emerald-100 dark:border-slate-700 text-xs text-gray-600 dark:text-slate-300">
                    Redeemed: <span className="text-emerald-600 dark:text-emerald-400 font-bold">{summary.redeemed}</span>
                </div>
        ...
        <div className="rounded-xl border border-gray-200 dark:border-slate-800/50 overflow-hidden bg-gray-50 dark:bg-slate-950/30">
            ...
            {coupons.length === 0 ? (
                <div className="p-12 text-center flex flex-col items-center justify-center">
                    ...
                    <h4 className="text-gray-900 dark:text-white font-medium mb-1">No coupons generated yet</h4>
                    <p className="text-sm text-gray-500 dark:text-slate-500">Create a campaign to generate QR coupons.</p>
                </div>
                                    ...
                                    <tr key={coupon.id} className="group hover:bg-gray-50 dark:hover:bg-slate-900/50 transition-colors">
                                        <td className="px-6 py-3">
                                            <div className="flex items-center gap-2">
                                                <span className="font-mono font-bold text-gray-900 dark:text-white tracking-wide">{coupon.coupon_code}</span>
                                                <button 
